...
<head>
    ...
    <link rel="shortcut icon" href="../icons/person-solid.svg" type="image/svg+xml">
        ...
        <table class="table table-dark table-striped" id="tabela_Clientes">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td scope="row"><a href="<?php echo "../operaçõesCRUD/delete.php? var_id=".$i['id']."&tabela=clientes"?>">Excluir</a></td>
                </tr>
            </tbody>
                <?php
                } // final while
